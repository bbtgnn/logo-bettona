...
```bash
node "/Users/giovanniabbatepaolo/Documents/GitHub/aba-perugia/logo-bettona/.cursor/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/giovanniabbatepaolo/Documents/GitHub/aba-perugia/logo-bettona/.cursor/get-shit-done/templates/retrospective.md`.
