...
```
Task(
  prompt="Read /Users/giovanniabbatepaolo/Documents/GitHub/aba-perugia/logo-bettona/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/giovanniabbatepaolo/Documents/GitHub/aba-perugia/logo-bettona/.cursor/get-shit-done/templates/VALIDATION.md`
