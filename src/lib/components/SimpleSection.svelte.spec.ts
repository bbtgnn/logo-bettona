...
describe('SimpleSection', () => {
	...
	it('renders a morph editor per ring', async () => {
		composition.rings = [
			{ id: 'test-ring-0', color: '#000', templatePath: { cmds: ['M', 'L', 'Z'], crds: [0, 0, 10, 0] }, secondaryTemplatePath: null, morphT: 0, ringHeight: 0.25 },
			{ id: 'test-ring-1', color: '#000', templatePath: { cmds: ['M', 'L', 'Z'], crds: [0, 0, 10, 0] }, secondaryTemplatePath: null, morphT: 0, ringHeight: 0.25 }
		];
		render(SimpleSection);
